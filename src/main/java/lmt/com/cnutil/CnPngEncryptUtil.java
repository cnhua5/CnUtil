...
public class CnPngEncryptUtil {
    ...
    public static byte[] reveal(InputStream input) {
        ...
        // Log.d("HEHE", "Decode BitMap Use " + (System.currentTimeMillis() -
        // time));
        ...
        // Log.d("HEH", "Get Length use: " + (System.currentTimeMillis() -
        // time));
        // time = System.currentTimeMillis();
        ...
        // Log.d("HEHE", "Get Data Use: " + (System.currentTimeMillis() -
        // time));
    ...
    public static boolean hide(byte[] data, File outputFile) {
        ...
        for (int i = 0; i < channelData.length; i += 3) {
            ...
            if (i + 2 < channelData.length)
                colorData = colorData & blueMask | (channelData[i + 2]);
